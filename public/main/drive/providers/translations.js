(function (angular) {
    ...
    angular.module('FileManagerApp').config(['$translateProvider', function ($translateProvider) {
        ...
        $translateProvider.translations('vi', {
            ...
            files_will_uploaded_to: 'Tệp tin sẽ được upload đến',
            ...
            source: 'Nguồn',
            destination: 'Đích',
            copy_file: 'Sao chép đến',
            sure_to_delete: 'Bạn có muốn xóa không?',
            change_name_move: 'Đổi tên / di chuyển',
            enter_new_name_for: 'Nhập một tên mới cho',
            extract_item: 'Giải nén',
            extraction_started: 'Tiến trình giải nén đang chạy nền',
            compression_started: 'Tiến trình nén đang chạy nền',
            enter_folder_name_for_extraction: 'Nhập tên thư mục để giải nén từ : ',
            enter_file_name_for_compression: 'Nhập tên file để nén từ : ',
            toggle_fullscreen: 'Toàn màn hình',
            edit_file: 'Sửa tệp tin',
            file_content: 'Nội dung tệp tin',
            loading: 'Đang tải',
            search: 'Tìm kiếm',
            create_folder: 'Tạo thư mục',
            create: 'Tạo',
            folder_name: 'Thư mục tên',
            upload: 'Tải lên',
            change_permissions: 'Thay quyền',
            change: 'Đổi',
            details: 'Chi tiết',
            icons: 'Biểu tượng',
            list: 'Danh sách',
            ...
            date: 'Ngày',
            selection: 'Chọn',
            no_files_in_folder: 'Thư mục rỗng',
            no_folders_in_folder: 'Thư mục không có thư mục con',
            select_this: 'Chọn cái này',
            go_back: 'Quay lại',
            wait: 'Đợi...',
            move: 'Di chuyển',
            download: 'Tải về',
            view_item: 'Xem tệp tin',
            remove: 'Xóa',
            edit: 'Sửa',
            copy: 'Sao chép',
            rename: 'Đổi tên',
            extract: 'Giải nén',
            compress: 'Nén',
            error_invalid_filename: 'Tệp tin bị trùng hoặc không hợp lệ',
            error_modifying: 'Có lỗi xảy ra',
            error_deleting: 'Có lỗi xảy ra',
            error_renaming: 'Có lỗi xảy ra',
            error_copying: 'Có lỗi xảy ra',
            error_compressing: 'Có lỗi xảy ra',
            error_extracting: 'Có lỗi xảy ra',
            error_creating_folder: 'Có lỗi xảy ra',
            error_getting_content: 'Có lỗi xảy ra',
            error_changing_perms: 'Có lỗi xảy ra',
            error_uploading_files: 'Có lỗi xảy ra',
            sure_to_start_compression_with: 'Bạn có chắc chắn nén file',
            owner: 'Owner',
            group: 'Group',
            others: 'Others',
            read: 'Read',
